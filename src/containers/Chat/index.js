...
class Chat extends Component {
  ...
  componentDidUpdate (prevProps, prevState) {
    ...
    if (messages !== prevState.messages) {
      getApplicationParse(messages, () => this.forceUpdate())
    }
